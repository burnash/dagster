            ...
            for i, definition in enumerate(_flatten(repository_definitions)):
                if isinstance(definition, CacheableAssetsDefinition):
                    if (
                        ...
                        cacheable_data = context.cacheable_asset_data[definition.unique_id]
                    ...
                    # is to match previous behavior of PendingRepositoryDefinition.
                        ...
                        cacheable_data = definition.compute_cacheable_data()
...
def repository(
    definitions_fn: Union[
        Callable[[], Sequence[PendingRepositoryListDefinition]], Callable[[], RepositoryDictSpec]
    ],
) -> RepositoryDefinition: ...
