...
LOOKER_SOURCE_METADATA_KEY_PREFIX = "dagster-looker/source"
    ...
    def build_defs(
        ...
        *,
        ...
        return LookerApiDefsLoader(
            ...
            request_start_pdt_builds=request_start_pdt_builds,
        ).build_defs()
...
class LookerApiDefsLoader(StateBackedDefinitionsLoader[Mapping[str, Any]]):
    ...
    def defs_key(self) -> str:
        return f"{LOOKER_SOURCE_METADATA_KEY_PREFIX}/{self.looker_resource.client_id}"
